...
package org.wso2.das.integration.tests.client;
...
public class H2DatabaseClient {
    ...
    public static int getTableEntryCount(String tableName) {
        ...
        try {
            ...
            stmt = con.prepareStatement("SELECT COUNT (*) AS totalRowCount FROM " + tableName + "");
    ...
    public static void clearConnections(PreparedStatement stmt, Connection con) {
        if (stmt != null) {
            try {
                stmt.close();
            } catch (SQLException e) {
